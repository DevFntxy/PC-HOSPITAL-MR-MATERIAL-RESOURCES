# ⌚ Wearable App - Sistema Hospitalario

Este directorio contiene todos los entregables, documentación y el código fuente de la aplicación para dispositivos vestibles (Smartwatches) diseñada para el sistema hospitalario.
