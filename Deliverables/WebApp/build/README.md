...
Este directorio contiene los archivos compilados y recursos generados para distribución y ejecución de la aplicación web.

## 📁 Contenido

* Archivos optimizados de producción.
* Recursos estáticos compilados.
* Builds del frontend y backend.
* Configuraciones listas para despliegue.

## 🚀 Objetivo

Centralizar los artefactos generados durante el proceso de compilación y preparación para producción.
