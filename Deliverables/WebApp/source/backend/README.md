...
Este directorio contiene la lógica backend de la aplicación web del sistema hospitalario.
...
* Manejo centralizado de datos y procesos.
* Integración con servicios externos y módulos internos.
